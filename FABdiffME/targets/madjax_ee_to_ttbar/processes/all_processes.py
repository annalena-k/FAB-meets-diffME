...
class Matrix_1_epem_ttx_t_budx_tx_bxdux(object):
    ...
    def get_external_masses(self, params):
        ...
        return ( (params["ZERO"], params["ZERO"]), (params["mdl_MB"], params["ZERO"], params["ZERO"], params["mdl_MB"], params["ZERO"], params["ZERO"]) )
...
# *   Decay: t~ > b~ s c~ WEIGHTED<=4
        ...
        w[2] = oxxxxx(p[2],mdl_MB,hel[2],+1)
        w[3] = oxxxxx(p[3],ZERO,hel[3],+1)
        w[4] = ixxxxx(p[4],ZERO,hel[4],-1)
        w[5]= FFV2_3(w[4],w[3],GC_100,mdl_MW,mdl_WW)
        w[4]= FFV2_1(w[2],w[5],GC_100,mdl_MT,mdl_WT)
        w[5] = ixxxxx(p[5],mdl_MB,hel[5],-1)
        w[2] = oxxxxx(p[6],ZERO,hel[6],+1)
        w[3] = ixxxxx(p[7],ZERO,hel[7],-1)
        w[6]= FFV2_3(w[3],w[2],GC_100,mdl_MW,mdl_WW)
        w[3]= FFV2_2(w[5],w[6],GC_100,mdl_MT,mdl_WT)
        w[6]= FFV1P0_3(w[1],w[0],GC_3,ZERO,ZERO)
        # Amplitude(s) for diagram number 1
        amp[0]= FFV1_0(w[3],w[4],w[6],GC_2)
        w[6]= FFV2_4_3(w[1],w[0],GC_50,GC_59,mdl_MZ,mdl_WZ)
        # Amplitude(s) for diagram number 2
        amp[1]= FFV2_5_0(w[3],w[4],w[6],-GC_50,GC_58)
