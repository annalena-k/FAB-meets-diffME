...
def FFV5_0(F1,F2,V3,COUP):
    ...
    vertex = COUP*(-1)*(+1j*(TMP0)+4j*(TMP2))
    return vertex



def FFV1_0(F1,F2,V3,COUP):
    TMP3 = (F1[2]*(F2[4]*(V3[2]+V3[5])+F2[5]*(V3[3]+1j*(V3[4])))+(F1[3]*(F2[4]*(V3[3]-1j*(V3[4]))+F2[5]*(V3[2]-V3[5]))+(F1[4]*(F2[2]*(V3[2]-V3[5])-F2[3]*(V3[3]+1j*(V3[4])))+F1[5]*(F2[2]*(-V3[3]+1j*(V3[4]))+F2[3]*(V3[2]+V3[5])))))
    vertex = COUP*-1j * TMP3
    return vertex
